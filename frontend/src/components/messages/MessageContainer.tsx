                ...
                <>
                    <div className='bg-gradient-to-r from-indigo-600 to-purple-600 px-4 md:px-6 py-4 flex items-center gap-3 shadow-lg flex-shrink-0'>
                        ...
                        <div className='relative'>
                            <div className='w-10 h-10 rounded-full overflow-hidden ring-2 ring-white/50 bg-gradient-to-br from-indigo-400 to-purple-500 flex items-center justify-center'>
                                {selectedConversation.type === "group" ? (
                                    (selectedConversation as Group & { type: "group" }).groupPic ? (
                                        <img src={(selectedConversation as Group & { type: "group" }).groupPic} alt='group avatar' className="w-full h-full object-cover" />
                                    ) : (
                        ...
                        <div className='flex-1 min-w-0'>
                            ...
                            {selectedConversation.type === "group" && (
                                <span className='text-white/80 text-xs truncate block'>{(selectedConversation as Group & { type: "group" }).members?.length || 0} members</span>
                            )}
                        </div>
                    </div>
                    <Messages />
